...
from pyArank import *
from pyArank.fns.tools import translate
...
ARAConfig.lang = udB.get_key("language") or os.getenv("LANGUAGE", "en")
...
load(PATH.format(ARAConfig.lang))


def get_string(key: str, _res: bool = True) -> Any:
    lang = ARAConfig.lang or "en"
    try:
