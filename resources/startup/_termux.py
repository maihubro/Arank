...
COPYRIGHT = f"©️ Mr_Mrs_Krishna {datetime.now().year}"
...
3. Some of the plugins are disabled for 'Termux Users' to save resources (by adding in EXCLUDE_OFFICIAL).
   - Read More - https://t.me/ArankUpdates/36
...
{Fore.BLACK}{Back.WHITE} _____________ 
 ...
 /_/   \_\_|  \__,_|_| |_|_|\_\
{Style.RESET_ALL}
{Fore.GREEN}- Arank Termux Installation -
  The Main Aim of this script is to deploy Arank with basic requirements and save your phone resources.
{Fore.RESET}
...
print(f"{Fore.YELLOW}* Do you want to get Arank Logs in Colors? [Y/N] ")
...
sleep(0.2)
print(f"Use 'bash startup' to try running Arank.{Fore.RESET}")
sleep(0.5)
print(
    "\nYou can head over to @Carding_Chronicle, if you get stuck somewhere, and need help."
)
sleep(0.5)
print("\nMade with ❤️ by @Mr_Mrs_Krishna...")
