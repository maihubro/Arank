...
from pyArank.fns.misc import google_search
...
ultpic = "https://telegra.ph/file/0b9d7bd278272147f1f3c.jpg"
...
async def repo(e):
    ...
    await e.answer(res, switch_pm="Arank Repo.", switch_pm_param="start")
...
async def piston_run(event):
    try:
        ...
        result = await event.builder.article(
            ...
            text=f'**Inline Usage**\n\n`@{asst.me.username} run python print("hello world")`\n\n[Language List](https://graph.org/Arank-09-01-6)',
        )
    ...
    if lang in PISTON_LANGS.keys():
        ...
        result = await event.builder.article(
            ...
            text=f'**Inline Usage**\n\n`@{asst.me.username} run python print("hello world")`\n\n[Language List](https://graph.org/Arank-02-18)',
        )
        return await event.answer([result])
        ...
        return await ult.answer(
            [
                await ult.builder.article(
                    title="How to Use?",
                    description="Tl Searcher by Arank",
                    url="https://t.me/Mr_Mrs_Krishna",
                    text=text,
                )
            ],
            switch_pm="Tl Search 🔍",
...
InlinePlugin.update(
    {
        ...
        "Sᴇᴀʀᴄʜ Oɴ Gᴏᴏɢʟᴇ": "go Mr_Mrs_Krishna",
        "WʜɪSᴘᴇʀ": "wspr @username Hello🎉",
        "YᴏᴜTᴜʙᴇ Dᴏᴡɴʟᴏᴀᴅᴇʀ": "yt Ed Sheeran Perfect",
        "Piston Eval": "run javascript console.log('Hello Arank')",
        "OʀᴀɴɢᴇFᴏx🦊": "ofox beryllium",
        "Tᴡɪᴛᴛᴇʀ Usᴇʀ": "twitter theArank",
