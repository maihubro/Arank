...
from . import eod, eor, get_string, mediainfo, Arank_cmd
...
@Arank_cmd(pattern="setbio( (.*)|$)", fullsudo=True)
async def _(ult):
    ok = await ult.eor("...")
...
@Arank_cmd(pattern="setname ?((.|//)*)", fullsudo=True)
async def _(ult):
    ok = await ult.eor("...")
...
@Arank_cmd(pattern="setpic$", fullsudo=True)
async def _(ult):
    if not ult.is_reply:
...
@Arank_cmd(pattern="delpfp( (.*)|$)", fullsudo=True)
