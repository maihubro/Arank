...
from pyArank.startup.loader import load_addons

from . import LOGS, async_searcher, eod, get_string, safeinstall, Arank_cmd, un_plug


@Arank_cmd(pattern="install", fullsudo=True)
...
@Arank_cmd(pattern="getaddons( (.*)|$)", fullsudo=True)
