...
try:
    ...
    Image = None
from pyArank.fns.misc import unsplashsearch
from pyArank.fns.tools import LogoHelper

from . import OWNER_ID, OWNER_NAME, download_file, get_string, mediainfo, Arank_cmd


@Arank_cmd(pattern="logo( (.*)|$)")
    ...
    if not bg_:
        if event.client._bot:
            ...
            async for i in event.client.iter_messages(
                "@ArankLogos", filter=InputMessagesFilterPhotos
            ):
                pics.append(i)
