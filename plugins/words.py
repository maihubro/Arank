...
from pyArank.fns.misc import get_synonyms_or_antonyms
from pyArank.fns.tools import async_searcher

from . import get_string, Arank_cmd


@Arank_cmd(pattern="meaning( (.*)|$)", manager=True)
